...
resource "aws_key_pair" "example" {
  key_name = "varkey" # Replace with your desired key name
...
#   }
  ...
  resource "aws_instance" "server" {
    ...
    provisioner "file" {
      source = "file23"   # Replace with the path to your local file
      destination = "/home/ubuntu/file23" # Replace with the path on the remote instance
    }
